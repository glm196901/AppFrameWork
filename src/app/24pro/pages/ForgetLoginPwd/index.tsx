...
class Index extends Component<Props> {
  ...
  render() {
    ...
    return (
      <div>
        <Header>忘记登录密码</Header>
        <div className={styles['login']}>找回登录密码</div>
        {step === 1 ? (
            ...
            <Modal
              ...
              footer={[
                ...
                },
                {
                  text: '确定',
                  onPress: () => {
                    this.validImgCode(phone, imgCode, 1);
                    this.updateImgCode();
        ...
        {step === 3 ? (
          <div className={styles['login-input']}>
            <div className={styles['login-input-phone']}>
              <div className={styles['login-input-phone-tip']}>登录密码</div>
              <div className={styles['login-input-phone-wrap']}>
                <List className={styles['login-input-phone-wrap-number']}>
                  <InputItem
            ...
            <div className={styles['login-input-pwd']}>
              <div className={styles['login-input-pwd-tip']}>确认登录密码</div>
              <div className={styles['login-input-pwd-wrap']}>
                <List className={styles['login-input-pwd-wrap-password']}>
                  <InputItem
